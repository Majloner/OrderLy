...
- [x] 4.1 Testy przechodzą: `npm run test` — 1728c6c
- [x] 4.2 Typy przechodzą: `npm run typecheck` — 1728c6c
- [x] 4.3 Lint przechodzi: `npm run lint` — 1728c6c
- [x] 4.4 Build SSR przechodzi: `npm run build` — 1728c6c
...
- [x] 5.1 Testy geometrii uchwytów przechodzą: `npm run test` — 2790ac2
- [x] 5.2 Typy przechodzą: `npm run typecheck` — 2790ac2
- [x] 5.3 Lint przechodzi: `npm run lint` — 2790ac2
- [x] 5.4 Build SSR przechodzi: `npm run build` — 2790ac2
