...
- [ ] 4.1 `npm run test:rls:local` runs to completion (exit 0) against local Supabase, printing Risk #2 notices
- [ ] 4.2 Existing 23 RLS assertions still pass unchanged
